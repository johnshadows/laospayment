...
<html lang="en">
  ...
  <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
    ...
    <li class="nav-item dropdown">
        <a class="nav-link dropdown-toggle <? if($_GET['page']=='deposit')echo 'active' ?>" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
          วิธีการฝาก
        </a>
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          <a class="dropdown-item" href="?page=deposit&broker=xm">โบรก XM</a>
          <a class="dropdown-item" href="?page=deposit&broker=exness">โบรก Exness</a>
        </div>
      </li>

      <li class="nav-item dropdown">
        <a class="nav-link dropdown-toggle <? if($_GET['page']=='withdraw')echo 'active' ?>" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
          วิธีการถอน
        </a>
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          <a class="dropdown-item" href="?page=withdraw&broker=xm">โบรก XM</a>
          <a class="dropdown-item" href="?page=withdraw&broker=exness">โบรก Exness</a>
        </div>
      </li>
